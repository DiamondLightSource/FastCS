...
async def test_create_and_link_read_pv(mocker: MockerFixture):
    ...
    attribute = AttrR(Int())
    attribute.add_on_set_callback = mocker.MagicMock()
    ...
    attribute.add_on_set_callback.assert_called_once_with(mocker.ANY)
    record_set_callback = attribute.add_on_set_callback.call_args[0][0]
